...
Why is it tempting to use flow analysis above other options, how does the interaction of having a weak typing system and back propagation naturally lend itself to [[CFA]]?
...
## Question:
How is [[CFA]] different from other program analysis techniques. What are the pros and cons, and where can I learn more?
